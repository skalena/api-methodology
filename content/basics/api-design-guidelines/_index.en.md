...
{{% notice note %}}
This original content was originated published at: https://github.com/paypal/api-standards/blob/master/api-style-guide.md
Thanks PayPal for such great reference, that can help many developer around the world.
{{% /notice%}}
...
Please refer to [Patterns And Use Cases](../patterns).
